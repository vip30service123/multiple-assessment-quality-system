CREATE DEFINER=`root`@`localhost` PROCEDURE `GetFacultyGraph`(academic_year VARCHAR(50), semester VARCHAR(50), program VARCHAR(50), module VARCHAR(50), lecturer VARCHAR(50), class VARCHAR(50))
BEGIN
