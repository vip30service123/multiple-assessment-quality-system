CREATE DEFINER=`root`@`localhost` PROCEDURE `GetModuleGraph`(academic_year VARCHAR(50), semester VARCHAR(50), program VARCHAR(50), faculty VARCHAR(50), lecturer VARCHAR(50), class VARCHAR(50))
BEGIN
